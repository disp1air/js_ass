...
name - содержит значение свойства name функции-конструктора, создающей объект. Это может быть строка  «Error», соответствующая универсальному конструктору, или более узкоспециализированное значение, такое как «RangeError».
message - Строка, которая передается конструктору при создании объекта.

С другой стороны, инструкция throw способна принимать любые объекты, не обязательно созданные с помощью какого-либо из конструкторов семейства Error
